...
<ul>
  <li>I am going to be adding the "Chronological" tag to all posts so in the blog archive page there will be a category that has all the post in date order from beginning to end.
</li>
  ...
  <li>Oh and there will now be a "Planned Posts" and "Changelog" section at the end of each post.</li>
</ul>
